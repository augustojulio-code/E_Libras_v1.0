...
public class Fragment_Previa_05 extends Fragment implements View.OnClickListener
{
    ImageView proximo;
    ...
    {
        View view = inflater.inflate(R.layout.fragment_previa_05_ativi_1, container,false);

        proximo = view.findViewById(R.id.btn_previa_05_atvi_01);
