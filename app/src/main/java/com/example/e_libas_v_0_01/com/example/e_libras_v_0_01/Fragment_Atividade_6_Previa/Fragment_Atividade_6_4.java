...
public class Fragment_Atividade_6_4 extends Fragment implements View.OnClickListener
{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState)
    {
        ...
        Glide.with(getActivity()).load(R.drawable.cores_preto).into(gif_palavra);

        opcao01.setText("Verde");
        opcao02.setText("Amarelo");
        opcao03.setText("Preto");
        opcao04.setText("Branco");
    ...
    public void onClick(View view)
    {
        ...
        if (view == btn_next) {
            ...
            recursos.ratingBar(Fragment_Atividade_6_4.this,acertos);
        }
    }
